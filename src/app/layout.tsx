...
export const metadata: Metadata = {
  ...
  description:
    "15 готовых AI-приложений для автоматизации продаж, маркетинга и операционки. Работают за 72 часа без разработчиков.",
  keywords: [
    "AI автоматизация",
    "AI для продаж",
    "лидогенерация",
  ...
  openGraph: {
    ...
    description:
      "15 готовых AI-приложений для автоматизации продаж, маркетинга и операционки. Запуск за 72 часа.",
    type: "website",
    locale: "ru_RU",
