...
export const ru: Content = {
  ...
  meta: {
    ...
    ogAlt: "AI Integrator — AI-маркетплейс для продаж",
  },
  ...
  hero: {
    ...
    headingLead: "Ваш AI-маркетплейс для ",
    headingAccent: "продаж и привлечения клиентов",
    subtitle:
      "15 готовых приложений для автоматизации продаж, маркетинга и операционки. Работают за 72 часа без разработчиков.",
  ...
  problems: {
    ...
    boxTitle: "Большинству нужны инструменты, но:",
    boxItems: [
      "— Zapier/Make слишком сложные (нужен разработчик)",
      "— HubSpot дорогой (от $45/месяц за место)",
      "— Кустарные решения не масштабируются",
    ],
    imageAlt: "Предприниматель, перегруженный хаосом ручных процессов",
  },

  features: {
    title: "15 готовых AI-инструментов для вашего бизнеса",
    subtitle:
      "Выберите нужные приложения и начните работать через 72 часа — каждый бот берёт на себя свою часть рутины: лидов, аналитику, переписку и контент.",
    imageAlt:
  ...
  results: {
    ...
    rating: "4.8/5 средняя оценка",
    ratingAria: "Оценка 4.8 из 5",
    advantages: [
      {
  ...
  pricing: {
    ...
    subtitle:
      "Демо инструментов и консультация — бесплатно. Платите только за сборку под вашу нишу и поддержку.",
    imageAlt:
    ...
    footnote:
      "Сначала — бесплатное демо инструментов и консультация. Сборка оплачивается один раз, подписка — только за поддержку и обновления.",
  },
  ...
  finalCta: {
    ...
    subtitle: "Присоединись к 50+ компаниям, которые уже используют AI Integrator",
