...
export const ru: Content = {
  ...
  meta: {
    title: "AI Integrator — 16 AI-инструментов для продаж и привлечения клиентов",
    description:
  ...
  nav: {
    ...
    seeAllApps: "Смотреть все 16 приложений",
    soonBadge: "Скоро",
  ...
  hero: {
    ...
    headingLead: "16 AI-инструментов для ",
  ...
  features: {
    title: "16 AI-инструментов для вашего бизнеса",
    subtitle:
  ...
  appPages: {
    poaching: {
      metaTitle: "Poaching — лиды из Threads под вашу нишу | AI Integrator",
      metaDescription:
        "Укажите нишу — Poaching ищет в Threads людей, которые прямо сейчас ищут вашу услугу, и отдаёт первый лид бесплатно. Если лидов нет — честно скажем.",
      badge: "Poaching",
      titleLead: "Poaching — ",
      titleAccent: "люди, которые ищут вашу услугу",
      subtitle:
        "Люди, которые пишут «посоветуйте», «ищу», «сколько стоит», — уже тёплые лиды. Укажите нишу — мы найдём такого человека в Threads. Первый лид бесплатно.",
    },
    bizdoctor: {
