 ...
 * Дата · Email · Канал связи · Контакт · Написать · Созвон · Часовой пояс ·
 * Интерес · Контекст · Имя · Компания · Источник. Скрипт проставляет заголовки
 * только на пустом листе: если таблица уже с данными, шапку правят руками
 * (об этом есть блок в инструкции).
 */
