  ...
  theme: {
    extend: {
      colors: {
        ...
        secondary: "#8A8F98",
        // Глубокий петроль вместо фиолетового — тот самый "AI-градиент",
        // который узнаётся в любом ИИ-стартапе с первого взгляда. Петроль +
        // бронза (accent-blue/accent-violet ниже) читаются как осознанный,
        // не шаблонный выбор: ближе к консалтингу/fintech, чем к hackathon-демо.
        accent: "#0F7C77",
        "accent-hover": "#159089",
        ...
        // холодный тил-циан против тёплой бронзы — контраст без ухода в
        // повторный фиолет/синий.
        "accent-blue": "#2E9E97",
        "accent-violet": "#B08D57",
      },
      ...
      boxShadow: {
        ...
        "glow-accent":
          "0 0 0 1px rgba(15,124,119,0.5), 0 8px 28px -10px rgba(15,124,119,0.45)",
        "glow-accent-sm":
          "0 0 0 1px rgba(15,124,119,0.35), 0 2px 12px -6px rgba(15,124,119,0.3)",
      },
      keyframes: {
